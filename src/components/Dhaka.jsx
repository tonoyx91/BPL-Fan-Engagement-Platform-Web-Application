...
function Dhaka() {
  return (
    <div>
      ...
      <h1 className="font-extrabold font-rowdies text-6xl text-yellow-500 pt-3" align="Center">Dhaka Dominators</h1>
      <div className="font-rowdies text-lg font-light items-center justify-center pt-8 relative bg-black">
        ...
        <li>
          <button onClick={() => window.location.href = '/dhaka'}><img src="/Dhaka.jpg" alt=""/></button>
        </li>
        </ul>
        </div>
      </div>
